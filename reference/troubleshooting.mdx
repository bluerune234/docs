...
Wovly logs to the console. Open DevTools with `Cmd + Option + I`.

### GitHub Issues

Wovly is in beta and we appreciate your feedback! Report bugs and request features at [GitHub Issues](https://github.com/wovly/wovly/issues).
