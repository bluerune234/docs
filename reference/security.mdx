...
Your application data stays on your machine:
...
This data is never synced to cloud servers or Wovly servers.

<Warning>
  **Important:** When you chat with Wovly, your messages are sent to your chosen LLM provider (Anthropic, OpenAI, or Google) via their APIs. Review the [LLM Privacy](#llm-privacy) section for details on what is sent.
</Warning>
...
<Note>
  Windows (DPAPI) and Linux (Secret Service) support coming soon.
</Note>
